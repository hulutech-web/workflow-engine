...
export default () => {
  ...
  const gridDeptOptions = reactive<VxeGridProps<RowVO>>({
    border: "full",
    size: "small",
    treeConfig: {
      transform: true,
      ...
      ajax: {
        ...
        query: ({page, sorts, filters, form}) => {
          return new Promise(async (resolve, reject) => {
            ...
            const {data} = await request.Get(`dept?pageSize=${page.pageSize}&currentPage=${page.currentPage
    ...
    columns: [
      ...
      { field: "dept_name", title: "名称", width: 100, treeNode: true  },
      // 配置日期选择器
      {
        field: "Manager",
        title: "经理",
