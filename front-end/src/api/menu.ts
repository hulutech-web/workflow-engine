...
export async function menuAdd(body: API.MenuAddReq, options?: RequestOptions) {
...
export async function menuDelete(body: API.IdReq, options?: RequestOptions) {
...
export async function menuEdit(body: API.MenuEditReq, options?: RequestOptions) {
...
export async function menuList(options?: RequestOptions) {
...
export async function menuRoute(options?: RequestOptions) {
