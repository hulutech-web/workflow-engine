...
func (r *EngineService) Create() http.Response {
...
func (r *EngineService) Index() http.Response {
	return nil
}

func (r *EngineService) Show() http.Response {
...
func (r *EngineService) EntryData() http.Response {
	id := ctx.Request().RouteInt("id")
...
func (r *EngineService) Store() http.Response {
	//添加发起节点
...
func (r *EngineService) Update() http.Response {
	return nil
}

func (r *EngineService) Destroy() http.Response {
	return nil
}

// 重发
func (r *EngineService) Resend() http.Response {
...
func NewEnginService(db *gorm.DB) EngineService {
